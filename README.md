...
Qiita・Zenn・技術ブログなど、RSS フィードを持つサイトの URL を登録しておくと、記事タイトルと URL を定期的に取得して DB に蓄積する。

各サイトは「今」の記事しか表示しないが、このアプリを使うと**過去に公開された記事の履歴**が手元の DB に残り続ける。複数サイトを個別に巡回する手間なく、新着記事を一箇所にまとめられるのが主な用途。
